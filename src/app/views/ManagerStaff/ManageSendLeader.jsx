...
import { updateProposal } from 'app/redux/actions/ProposalAction'
import { updateProcess } from 'app/redux/actions/ProcessActions'

const ManageSendLeader = (props) => {
    const { t, handleCloseParentDialog, itemData, isSalary, isProposal, isProcess, handleCloseDialog } = props
    ...
    const onChange = (e) => {
        ...
        if (name === 'leaderId') {
            ...
            console.log(selectedLeader.leaderPosition)
            setFormData({
                ...formData,
                [name]: value,
